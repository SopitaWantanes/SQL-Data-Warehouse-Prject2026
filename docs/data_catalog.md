...
## 📘 Overview
The Gold Layer is the business data-level data representation, structured to support analytical and reporting use cases. It consists of **dimension tables** and **fact tables** for specific business metrics.
...
| end_date             | DATE         | The date when the product is no longer active (NULL = current product).    |
